...
- Name: 02-quiz-lifecycle.spec.ts >> publish a draft quiz — quiz appears in the list as Published
- Location: tests/02-quiz-lifecycle.spec.ts:55:5

# Error details

```
Error: POST /api/quizzes → 500: {"timestamp":"2026-05-09T21:52:54.094+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes"}
```
