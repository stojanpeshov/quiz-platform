...
- Name: 06-points.spec.ts >> completing an attempt adds +5 to the point history
- Location: tests/06-points.spec.ts:21:5

# Error details

```
Error: POST /api/quizzes → 500: {"timestamp":"2026-05-09T21:53:27.786+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes"}
```

```
Error: DELETE /api/quizzes/undefined → 500: {"timestamp":"2026-05-09T21:53:27.817+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes/undefined"}
```
