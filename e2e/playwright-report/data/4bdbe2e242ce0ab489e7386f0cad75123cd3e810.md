...
- Name: 09-admin.spec.ts >> admin dashboard shows platform stats
- Location: tests/09-admin.spec.ts:15:5

# Error details

```
Error: GET /api/me/points → 500: {"timestamp":"2026-05-09T21:53:29.227+00:00","status":500,"error":"Internal Server Error","path":"/api/me/points"}
```
