...
- Name: 08-leaderboards.spec.ts >> Global leaderboard renders the Global tab with user rows
- Location: tests/08-leaderboards.spec.ts:24:5

# Error details

```
Error: POST /api/quizzes → 500: {"timestamp":"2026-05-09T21:53:28.752+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes"}
```

```
Error: DELETE /api/quizzes/undefined → 500: {"timestamp":"2026-05-09T21:53:28.780+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes/undefined"}
```
