...
- Name: 03-browse.spec.ts >> published quiz appears on the Browse page
- Location: tests/03-browse.spec.ts:23:5

# Error details

```
Error: POST /api/quizzes → 500: {"timestamp":"2026-05-09T21:53:26.321+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes"}
```

```
Error: DELETE /api/quizzes/undefined → 500: {"timestamp":"2026-05-09T21:53:26.351+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes/undefined"}
```
