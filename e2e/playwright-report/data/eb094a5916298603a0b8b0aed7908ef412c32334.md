...
- Name: 07-achievements.spec.ts >> First Steps achievement is earned after the first completed attempt
- Location: tests/07-achievements.spec.ts:22:5

# Error details

```
Error: POST /api/quizzes → 500: {"timestamp":"2026-05-09T21:53:28.268+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes"}
```

```
Error: DELETE /api/quizzes/undefined → 500: {"timestamp":"2026-05-09T21:53:28.303+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes/undefined"}
```
