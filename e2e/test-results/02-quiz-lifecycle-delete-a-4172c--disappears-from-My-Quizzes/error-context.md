...
- Name: 02-quiz-lifecycle.spec.ts >> delete a quiz — it disappears from My Quizzes
- Location: tests/02-quiz-lifecycle.spec.ts:110:5

# Error details

```
Error: POST /api/quizzes → 500: {"timestamp":"2026-05-09T21:53:25.794+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes"}
```
