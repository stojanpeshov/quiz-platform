...
- Name: 02-quiz-lifecycle.spec.ts >> publishing awards +20 points and shows the Knowledge Sharer achievement toast
- Location: tests/02-quiz-lifecycle.spec.ts:71:5
...
Call log:
  - waiting for locator('li').filter({ hasText: 'E2E True/False Quiz' }).getByRole('button', { name: 'Publish' })
      ...
      - list [ref=e21]:
        - listitem [ref=e22]:
          - link "E2E True/False Quiz draft · 1 q" [ref=e23] [cursor=pointer]:
            - /url: /quizzes/8bbc844b-a5f8-4df3-ab75-9e54751461f1
