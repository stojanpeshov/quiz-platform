...
- Name: 04-take-quiz.spec.ts >> take a quiz — answer all four question types and submit
- Location: tests/04-take-quiz.spec.ts:20:5

# Error details

```
Error: POST /api/quizzes → 500: {"timestamp":"2026-05-09T21:53:26.809+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes"}
```

```
Error: DELETE /api/quizzes/undefined → 500: {"timestamp":"2026-05-09T21:53:26.839+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes/undefined"}
```
