...
- Name: 05-rating.spec.ts >> rate a quiz after completing an attempt
- Location: tests/05-rating.spec.ts:23:5

# Error details

```
Error: POST /api/quizzes → 500: {"timestamp":"2026-05-09T21:53:27.300+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes"}
```

```
Error: DELETE /api/quizzes/undefined → 500: {"timestamp":"2026-05-09T21:53:27.330+00:00","status":500,"error":"Internal Server Error","path":"/api/quizzes/undefined"}
```
